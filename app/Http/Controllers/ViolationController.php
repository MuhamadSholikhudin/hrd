...
class ViolationController extends Controller
{
          ...
          // echo $date_end_violation; //print tanggal
            ...
            if($last_vio == 'notactive' AND $last_type == 'notviolation'){
                ...
                if($num_vio_accumulation > 0){
                    ...
                    elseif($last_type == 'Peringatan Lisan' AND $last_accumulation = 0.5 AND $sel_paragraph->type_of_verse == 'Surat Peringatan Pertama'){
                        $status_type_violation = 'Surat Peringatan Pertama';
                        $accumulation = 1.5;
                    }
                    ...
                    elseif($last_type == 'Peringatan Lisan' AND $last_accumulation = 0.5 AND $sel_paragraph->type_of_verse == 'Surat Peringatan Ketiga'){
                        $status_type_violation = 'Surat Peringatan Ketiga';
                        $accumulation = 3.5;
                    }
                ...
                if($num_vio_accumulation2 > 0){
                    ...
                    if($num_vio_accumulation > 0){
                        ...
                        if($num_pasal_akumulasi > 0){
                            ...
                            // $cari_pasal_akumulasi = ['id' => 1, 'article'=> 2, 'paragraph'=> 'q','alphabet' => 'a', 'alphabet_sound' => 'oke'];
                        }
    ...
    private function get_accumulation(){
        // GET LOGIKA AKUMULASI PERTAMA PERINGATAN LISAN
        if($last_type == 'Peringatan Lisan' AND $last_accumulation = 0.5 AND $sel_paragraph->type_of_verse == 'Peringatan Lisan'){
            $status_type_violation = 'Surat Peringatan Pertama';
            $accumulation = 1;
