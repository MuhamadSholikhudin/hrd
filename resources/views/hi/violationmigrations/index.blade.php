    ...
    <div class="card-header">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
          ...
          <tbody>
            @foreach($violationmigrations as $violation)
              <tr>
                <td>{{ $violation->id }}</td>
                ...
                <td>{{nomer_sp_migrasi($violation->no_violation, $violation->id);}}           </td>
                ...
                <td>
                    <a href="/violationmigrations/{{$violation->id }}" target="_blank" class="btn  btn-outline-primary">
                      Cetak                    
                    </a>
