        ...
        <div class="container-fluid">
            ...
            <div class="card  border-0">
                ...
                <div class="body">
                    ...
                    <div class="col-sm-12 lead" style="text-align: justify;"> {{$violation->alphabet_id}}</div>
                    ...
                    <div class="col-sm-12 lead"><b>Keterangan lain :</b></div>
                        ...
                        <table >
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">&nbsp;&nbsp;&nbsp;-</td>
                                    <td valign="top" class="lead" style="text-align: justify;">{{ $violation->violation_accumulation}}</td>
                                </tr>

                                <tr>
                                    <td valign="top">&nbsp;&nbsp;&nbsp;-</td>
                                    <td valign="top" class="lead" style="text-align: justify;"> {{ $violation->violation_accumulation2}}  </td> 
                                </tr>           
                            </tbody>
                        </table>
