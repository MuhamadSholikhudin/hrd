              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="input_personal">
                    ...
                    @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" value="{{ old('place_of_birth', $employee->place_of_birth) }}" >
                        </div>
                        <label for="place_of_birth" class="col-sm-2 col-form-label">Tanggal lahir</label>
                        <div class="col-sm-4">
                            <input type="date" class="form-control" id="place_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $employee->date_of_birth) }}"  > 
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="tab-pane" id="input_identitas">
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="national_id" name="national_id" value="{{ old('national_id', $employee->national_id) }}" placeholder="Nomer KTP" >
                          </div>
                        </div>               
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="address_province" name="address_province" value="{{ old('address_province', $employee->address_province) }}" >
                      </div>
                      <label for="address_city" class="col-sm-2 col-form-label">Kota </label>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="address_city" name="address_city" value="{{ old('address_city', $employee->address_city) }}" >
                      </div>
                      <label for="address_district" class="col-sm-2 col-form-label">Kecamatan </label>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="address_district" name="address_district" value="{{ old('address_district', $employee->address_district) }}" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="address_village" class="col-sm-2 col-form-label">Desa </label>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="address_rw"   name="address_village" value="{{ old('address_village', $employee->address_village) }}" >
                      </div>
                      <label for="address_rt" class="col-sm-1 col-form-label">RT </label>
                      <div class="col-sm-1">
                        <input type="text" class="form-control" id="address_rt" name="address_rt" value="{{ old('address_rt', $employee->address_rt) }}" >
                      </div>
                      <label for="address_rt" class="col-sm-1 col-form-label">RW </label>
                      <div class="col-sm-1">
                        <input type="text" class="form-control" id="address_rw" name="address_rw" value="{{ old('address_rw', $employee->address_rw) }}" >
                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="address_jalan" name="address_jalan" value="{{ old('address_jalan', $employee->address_jalan) }}" >
                        </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control" name="educate" >
                        @foreach ($educations as $educations)
                          @if(old('educate', $employee->educate) == $educations)
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="major" name="major" value="{{ old('major', $employee->major) }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane" id="input_informasi_karyawan">
                  <div class="tab-pane" id="">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control" id="number_of_employees" name="number_of_employees" value="{{ old('number_of_employees', $employee->number_of_employees) }}" placeholder="Nomer Induk Karyawan" >
                      </div>
                      <label for="finger_id" class="col-sm-2 col-form-label">Finger ID</label>
                      <div class="col-sm-3">
                          <input type="text" class="form-control" id="finger_id" name="finger_id" value="{{ old('finger_id', $employee->finger_id) }}" placeholder="Finger ID" >
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <select class="form-control select2bs4" style="width: 100%;" name="job_id">
                            @foreach ($jobs as $job)
                              @if(old('job_id', $employee->job_id) == $job->id)
                        ...
                        <div class="form-group">
                          <select class="form-control select2bs4" name="department_id" style="width: 100%;">
                            @foreach ($departments as $department)
                              @if(old('department_id', $employee->department_id) == $department->id)
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="bagian" name="bagian" value="{{ old('bagian', $employee->bagian) }}" >
                        </div>
                      </div> 
                      <div class="form-group row">
                        <label for="hire_date" class="col-sm-3 col-form-label">CELL</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="cell" name="cell" value="{{ old('cell', $employee->cell) }}" >
                        </div>
                      </div> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" class="form-control" id="hire_date" name="hire_date" value="{{ old('hire_date', $employee->hire_date) }}" data-inputmask-inputformat="dd/mm/yyyy" >
                        </div>
                      </div>                      
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="employee_type" >
                              @foreach ($employee_type as $employee_type)
                                @if(old('employee_type', $employee->employee_type) == $employee_type)
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" class="form-control" id="end_of_contract" name="end_of_contract" value="{{ old('end_of_contract', $employee->end_of_contract) }}" data-inputmask-inputformat="dd/mm/yyyy" >
                        </div>
                      </div>    
                      <div class="form-group row">
                        <label for="out" class="col-sm-3 col-form-label">Date Out </label>
                        <div class="col-sm-9">
                          <input type="date" class="form-control" id="out" name="date_out" value="{{ old('date_out', $employee->date_out) }}" data-inputmask-inputformat="dd/mm/yyyy">
                        </div>
                      </div> 
                      <div class="form-group row">
                ...
                <div class="tab-pane" id="input_bpjs">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="bpjs_ketenagakerjaan" value="{{ old('bpjs_ketenagakerjaan', $employee->bpjs_ketenagakerjaan) }}" id="inputName2" placeholder="Name">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="bpjs_kesehatan" value="{{ old('bpjs_kesehatan', $employee->bpjs_kesehatan) }}" id="inputName2" placeholder="Name">
                    </div>
                    <label for="inputName2" class="col-sm-2 col-form-label">Tanggal gabung</label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" name="date_bpjs_kesehatan" value="{{ old('date_bpjs_kesehatan', $employee->date_bpjs_kesehatan) }}" data-inputmask-inputformat="dd/mm/yyyy" id="inputName2" placeholder="Name" >
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane" id="input_bank">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="bank_account_name" name="bank_account_name" value="{{ old('bank_account_name', $employee->bank_account_name) }}" >
                    </div>
                  </div>
                  <div class="form-group row">
               ...
               <div class="tab-pane" id="input_gaji">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="positional_allowance" name="positional_allowance" value="{{ old('positional_allowance', $salary->positional_allowance) }}" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="transportation_allowance" class="col-sm-3 col-form-label">Tunjangan Transportasi</label>
                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="transportation_allowance" name="transportation_allowance" value="{{ old('transportation_allowance', $salary->transportation_allowance) }}" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="attendance_allowance" class="col-sm-3 col-form-label">Tunjangan Kehadiran</label>
                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="attendance_allowance" name="attendance_allowance" value="{{ old('attendance_allowance', $salary->attendance_allowance) }}" >
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" name="grade_salary" >
                          @foreach ($grade_salary as $grade_salary)
                            @if(old('grade_salary', $salary->grade_salary) == $grade_salary)
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" id="total_salary" name="total_salary" value="{{ old('total_salary', $salary->total_salary) }}" >
                    </div>
                    <div class="col-sm-2">
...
<!-- 
                ...
                <div class="tab-pane" id="input_pajak">
                      ...
                      <div class="col-sm-4">
                          <select class="form-control" name="kode_ptkp" >
                              @foreach ($kode_ptkp as $kode_ptkp)
                                @if(old('kode_ptkp', $employee->kode_ptkp) == $kode_ptkp)
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="date" class="form-control" id="year_ptkp" name="year_ptkp" value="{{ old('year_ptkp', $employee->year_ptkp) }}" >
                    </div>
                  </div>
                </div>
