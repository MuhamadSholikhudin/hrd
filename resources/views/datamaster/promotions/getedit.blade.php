          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{  $promotion->number_of_employees  }}</h3>
                <h3 class="profile-username text-center">{{  $promotion->name  }}</h3>

                  <p class="text-muted text-center">{{ $promotion->job_level }} <br>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <select class="form-control select2bs4" style="width: 100%;" name="job_id">
                            @foreach ($jobs as $job)
                              @if(old('job_id', $promotion->job_id) == $job->id)
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <select class="form-control select2bs4" name="department_id" style="width: 100%;">
                            @foreach ($departments as $department)
                              @if(old('department_id', $promotion->department_id) == $department->id)
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputSkills" name="bagian" value="{{ old('bagian', $promotion->bagian) }}" placeholder="">
                          </div>
                        </div>
                         ...
                         <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputSkills" name="cell" value="{{ old('cell', $promotion->cell) }}" placeholder="">
                          </div>
                        </div>
